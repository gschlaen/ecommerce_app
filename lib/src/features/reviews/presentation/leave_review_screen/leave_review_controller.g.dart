...
String $LeaveReviewControllerHash() => r'183dd17f2af67d34958d172a3240b53abe9eced1';

/// See also [LeaveReviewController].
final leaveReviewControllerProvider = AutoDisposeAsyncNotifierProvider<LeaveReviewController, void>(
  LeaveReviewController.new,
  name: r'leaveReviewControllerProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product') ? null : $LeaveReviewControllerHash,
);
